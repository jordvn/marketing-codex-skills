import { $ as Protocol, $a as OAuthError, $i as SubscriptionsAcknowledgedNotification, $n as InitializeRequestParams, $r as PaginatedResult, $t as BaseMetadata, A as ResourceMetadata, Aa as CLIENT_INFO_META_KEY, Ai as ResourceTemplateType, An as ElicitRequest, Ar as ListRootsResult, At as UnsupportedProtocolVersionError, B as STDIO_DEFAULT_MAX_BUFFER_SIZE, Ba as PROTOCOL_VERSION_META_KEY, Bi as SamplingMessage, Bn as GetPromptRequest, Br as MetaObject, Bt as StandardSchemaV1Sync, C as PromptCallback, Ca as UnsubscribeRequest, Ci as RequestTypeMap, Cn as CreateMessageRequestParamsWithTools, Cr as ListPromptsRequest, Ct as isJSONRPCResponse, D as RegisteredResource, Da as UntitledSingleSelectEnumSchema, Di as ResourceListChangedNotification, Dn as Cursor, Dr as ListResourcesRequest, Dt as MissingRequiredClientCapabilityError, E as RegisteredPrompt, Ea as UntitledMultiSelectEnumSchema, Ei as ResourceLink, En as CreateTaskResult, Er as ListResourceTemplatesResult, Et as parseJSONRPCMessage, F as preloadSchemas, Fa as JSONRPC_VERSION, Fi as ResultTypeMap, Fn as ElicitationCompleteNotification, Fr as LoggingLevel, Ft as acceptedContent, G as ProtocolEra, Ga as TRACEPARENT_META_KEY, Gi as ServerResult, Gn as GetTaskRequest, Gr as MultiSelectEnumSchema, Gt as InboundLegacyRoute, H as serializeMessage, Ha as SERVER_INFO_META_KEY, Hi as ServerCapabilities, Hn as GetPromptResult, Hr as MissingRequiredClientCapabilityErrorData, Ht as InboundClassificationOutcome, I as InMemoryTransport, Ia as LATEST_PROTOCOL_VERSION, Ii as Role, In as ElicitationCompleteNotificationParams, Ir as LoggingMessageNotification, It as inputRequired, J as BaseContext, Ja as resourceUrlFromServerUrl, Ji as SingleSelectEnumSchema, Jn as Icon, Jr as NotificationParams, Jt as InboundValidationRung, K as getDisplayName, Ka as TRACESTATE_META_KEY, Ki as SetLevelRequest, Kn as GetTaskResult, Kr as Notification, Kt as InboundLegacyRouteReason, L as UriTemplate, La as LOG_LEVEL_META_KEY, Li as Root, Ln as EmbeddedResource, Lr as LoggingMessageNotificationParams, Lt as inputResponse, M as ToolCallback, Ma as INTERNAL_ERROR, Mi as ResourceUpdatedNotificationParams, Mn as ElicitRequestParams, Mr as ListTasksResult, Mt as ProtocolErrorCode, N as Server, Na as INVALID_PARAMS, Ni as Result, Nn as ElicitRequestURLParams, Nr as ListToolsRequest, Nt as InputRequiredSpec, O as RegisteredResourceTemplate, Oa as BAGGAGE_META_KEY, Oi as ResourceRequestParams, On as DiscoverRequest, Or as ListResourcesResult, Ot as ProtocolError, P as ServerOptions, Pa as INVALID_REQUEST, Pi as ResultMetaObject, Pn as ElicitResult, Pr as ListToolsResult, Pt as InputResponseView, Q as ProgressCallback, Qa as SdkHttpErrorData, Qi as SubscriptionFilter, Qn as InitializeRequest, Qr as PaginatedRequestParams, Qt as AuthInfo, R as Variables, Ra as METHOD_NOT_FOUND, Ri as RootsListChangedNotification, Rn as EmptyResult, Rr as MessageClassification, Rt as ElicitInputParams, S as McpServer, Sa as ToolUseContent, Si as RequestParams, Sn as CreateMessageRequestParamsBase, Sr as ListChangedOptions, St as isJSONRPCRequest, T as ReadResourceTemplateCallback, Ta as UnsupportedProtocolVersionErrorData, Ti as ResourceContents, Tn as CreateMessageResultWithTools, Tr as ListResourceTemplatesRequest, Tt as isTaskAugmentedRequestParams, U as CacheHint, Ua as SUBSCRIPTION_ID_META_KEY, Ui as ServerNotification, Un as GetTaskPayloadRequest, Ur as ModelHint, Ut as InboundHttpRequest, V as deserializeMessage, Va as RELATED_TASK_META_KEY, Vi as SamplingMessageContentBlock, Vn as GetPromptRequestParams, Vr as MethodNotFoundError, Vt as StandardSchemaWithJSON, W as CacheScope, Wa as SUPPORTED_PROTOCOL_VERSIONS, Wi as ServerRequest, Wn as GetTaskPayloadResult, Wr as ModelPreferences, Wt as InboundLadderRejection, X as DEFAULT_REQUEST_TIMEOUT_MSEC, Xa as SdkErrorCode, Xi as SubscribeRequest, Xn as ImageContent, Xr as NumberSchema, Xt as Annotations, Y as ClientContext, Ya as SdkError, Yi as StringSchema, Yn as Icons, Yr as NotificationTypeMap, Yt as classifyInboundRequest, Z as NotificationOptions, Za as SdkHttpError, Zi as SubscribeRequestParams, Zn as Implementation, Zr as PaginatedRequest, Zt as AudioContent, _ as PerRequestResponseMode, _a as ToolAnnotations, _i as RequestId, _n as CompleteRequestResourceTemplate, _r as JSONRPCResultResponse, _t as isInitializeRequest, a as McpRequestContext, aa as Task, ai as ProgressNotificationParams, an as CancelTaskRequest, ao as OAuthClientInformationMixed, ar as InputResponse, at as mergeCapabilities, b as CompleteResourceTemplateCallback, ba as ToolListChangedNotification, bi as RequestMetaObject, bn as CreateMessageRequest, br as ListChangedCallback, bt as isJSONRPCErrorResponse, c as isLegacyRequest, ca as TaskMetadata, ci as PromptArgument, cn as CancelledNotificationParams, co as OAuthErrorResponse, cr as InvalidParamsError, ct as TransportSendOptions, d as ServerEvent, da as TaskStatusNotificationParams, di as PromptReference, dn as ClientRequest, do as OAuthTokenRevocationRequest, dr as JSONObject, dt as SpecTypes, ea as SubscriptionsAcknowledgedNotificationParams, ei as ParseError, en as BlobResourceContents, eo as OAuthErrorCode, er as InitializeResult, et as ProtocolOptions, f as ServerEventBus, fa as TextContent, fi as ReadResourceRequest, fn as ClientResult, fo as OAuthTokens, fr as JSONRPCErrorResponse, ft as isSpecType, g as PerRequestMessageExtra, ga as Tool, gi as Request$1, gn as CompleteRequestPrompt, go as StoredOAuthTokens, gr as JSONRPCResponse, gt as isCallToolResult, h as PerRequestHTTPServerTransportOptions, ha as TitledSingleSelectEnumSchema, hi as RelatedTaskMetadata, hn as CompleteRequestParams, ho as StoredOAuthClientInformation, hr as JSONRPCRequest, ht as assertCompleteRequestResourceTemplate, i as McpHttpHandler, ia as SubscriptionsListenResultMeta, ii as ProgressNotification, in as CallToolResult, io as OAuthClientInformationFull, ir as InputRequiredResult, it as ServerContext, j as ResourceTemplate, ja as DEFAULT_NEGOTIATED_PROTOCOL_VERSION, ji as ResourceUpdatedNotification, jn as ElicitRequestFormParams, jr as ListTasksRequest, jt as UrlElicitationRequiredError, k as RegisteredTool, ka as CLIENT_CAPABILITIES_META_KEY, ki as ResourceTemplateReference, kn as DiscoverResult, kr as ListRootsRequest, kt as ResourceNotFoundError, l as legacyStatelessFallback, la as TaskStatus, li as PromptListChangedNotification, ln as ClientCapabilities, lo as OAuthMetadata, lr as InvalidRequestError, lt as createFetchWithInit, m as PerRequestHTTPServerTransport, ma as TitledMultiSelectEnumSchema, mi as ReadResourceResult, mn as CompleteRequest, mo as OpenIdProviderMetadata, mr as JSONRPCNotification, mt as assertCompleteRequestPrompt, n as LegacyHttpHandler, na as SubscriptionsListenRequestParams, ni as PrimitiveSchemaDefinition, nn as CallToolRequest, no as IdJagTokenExchangeResponse, nr as InputRequest, nt as RequestOptions, o as McpServerFactory, oa as TaskAugmentedRequestParams, oi as ProgressToken, on as CancelTaskResult, oo as OAuthClientMetadata, or as InputResponses, ot as FetchLike, p as ServerNotifier, pa as TextResourceContents, pi as ReadResourceRequestParams, pn as CompatibilityCallToolResult, po as OpenIdProviderDiscoveryMetadata, pr as JSONRPCMessage, pt as specTypeSchemas, q as isJsonContentType, qa as checkResourceAllowed, qi as SetLevelRequestParams, qn as HandlerResultTypeMap, qr as NotificationMethod, qt as InboundModernRoute, r as McpHandlerRequestOptions, ra as SubscriptionsListenResult, ri as Progress, rn as CallToolRequestParams, ro as OAuthClientInformation, rr as InputRequests, rt as RequestStateAccessor, s as createMcpHandler, sa as TaskCreationParams, si as Prompt, sn as CancelledNotification, so as OAuthClientRegistrationError, sr as InternalError, st as Transport, t as CreateMcpHandlerOptions, ta as SubscriptionsListenRequest, ti as PingRequest, tn as BooleanSchema, to as AuthorizationServerMetadata, tr as InitializedNotification, tt as RequestHandlerSchemas, u as InMemoryServerEventBus, ua as TaskStatusNotification, ui as PromptMessage, un as ClientNotification, uo as OAuthProtectedResourceMetadata, ur as JSONArray, ut as SpecTypeName, v as AnyToolHandler, va as ToolChoice, vi as RequestMeta, vn as CompleteResult, vr as JSONValue, vt as isInitializedNotification, w as ReadResourceCallback, wa as UnsubscribeRequestParams, wi as Resource, wn as CreateMessageResult, wr as ListPromptsResult, wt as isJSONRPCResultResponse, x as ListResourcesCallback, xa as ToolResultContent, xi as RequestMethod, xn as CreateMessageRequestParams, xr as ListChangedHandlers, xt as isJSONRPCNotification, y as BaseToolCallback, ya as ToolExecution, yi as RequestMetaEnvelope, yn as ContentBlock, yr as LegacyTitledEnumSchema, yt as isInputRequiredResult, z as ReadBuffer, za as PARSE_ERROR, zi as SamplingContent, zn as EnumSchema, zr as MessageExtraInfo, zt as StandardSchemaV1 } from "./createMcpHandler-DzBzpE4_.cjs";
import { i as jsonSchemaValidator, n as JsonSchemaValidator, r as JsonSchemaValidatorResult, t as JsonSchemaType } from "./types-DsbMXNFL.cjs";
...
//#endregion
//#region src/server/middleware/bearerAuth.d.ts
/**
 ...
 */
declare function verifyBearerToken(authorizationHeader: string | null | undefined, options: BearerAuthOptions): Promise<AuthInfo>;
/**
 ...
 * OAuth error JSON.
 */
declare function bearerAuthChallengeResponse(error: unknown, options?: Pick<BearerAuthOptions, 'requiredScopes' | 'resourceMetadataUrl'>): Response;
/**
 ...
 * ```
 */
declare function requireBearerAuth(options: BearerAuthOptions): (request: Request) => Promise<AuthInfo | Response>;
//#endregion
...
//#endregion
//#region src/server/middleware/oauthMetadata.d.ts
/**
 ...
 */
declare function buildOAuthProtectedResourceMetadata(options: AuthMetadataOptions): OAuthProtectedResourceMetadata;
/**
 ...
 * ```
 */
declare function getOAuthProtectedResourceMetadataUrl(serverUrl: URL): string;
/**
 ...
 * ```
 */
declare function oauthMetadataResponse(request: Request, options: AuthMetadataOptions): Response | undefined;
//#endregion
