...
const require_mcp = require('./mcp-DM1iHYFo.cjs');
const require_src = require('./src-BX_fm-dB.cjs');
	...
	*/
	...
	const connectInstance = async (era, revision) => {
		...
		if (era === "modern") {
			...
			listenRouter.setServerCapabilities(server.getCapabilities(), require_mcp.serverIdentityOf(server));
		}
