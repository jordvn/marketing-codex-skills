...
5. Build the narrative with `references/deck-blueprint.md`. Select only the slides that answer the audience's decision; keep the main deck to roughly 8–12 slides and move supporting detail to an appendix.
